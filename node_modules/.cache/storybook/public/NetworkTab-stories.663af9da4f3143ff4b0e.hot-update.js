...
const NetworkTab = () => {
  ...
  const getActiveChain = id => {
    const chain = _utils_data__WEBPACK_IMPORTED_MODULE_1__.data.find(d => d.chainId === id);
    setSelectedChain(chain);
  };

  // const filteringChain =(id)=>{
  //     id ==
  // }

  console.log(selectedChain, "hfhghghghghg");
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("button", {
        ...
        children: [_utils_data__WEBPACK_IMPORTED_MODULE_1__.data.filter(colos => console.log(colos)), isOpen && _utils_data__WEBPACK_IMPORTED_MODULE_1__.data.map((item, i) => {
...
//# sourceMappingURL=NetworkTab-stories.663af9da4f3143ff4b0e.hot-update.js.map